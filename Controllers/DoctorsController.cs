...
namespace BigBang_Assessment_2.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        public DoctorsController(HospitalConetxt context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Doctor>> PostDoctor(Doctor doctor)
        {
          if (_context.Doctors == null)
          {
              return Problem("Entity set 'HospitalConetxt.Doctors'  is null.");
          }
        ...
        {
            return (_context.Doctors?.Any(e => e.Doctor_Id == id)).GetValueOrDefault();
        }
    }
}
